                    ...
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <div>
                                    <img src="{{ $admin->avatar ?? '../assets/img/default-avatar.jpg' }}" class="avatar avatar-sm me-3" alt="{{ $admin->name }}">
                                </div>
                        ...
                        <td class="align-middle text-center">
                            <span class="text-secondary text-xs font-weight-bold">{{ $admin->mobile ?? 'N/A' }} </span>
                        </td>
                        <td class="align-middle">
                            <a href="{{ url('admin/edit/' . $admin->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                              <button class="btn btn-info">
                                Edit
                                </button>
                            </a>
                               <a href="{{ url('admin/delete/' . $admin->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delete user" onclick="return confirmDelete()">
