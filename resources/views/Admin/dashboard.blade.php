          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Money to be paid</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Pending Products</p>
                    <h5 class="font-weight-bolder mb-0">
                      {{ $pendingProductCount }}
                    </h5>
                  </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Pending Withdrawer</p>
                    <h5 class="font-weight-bolder mb-0">
                     {{ $withdrawCount }}
                      <!-- <span class="text-success text-sm font-weight-bolder">+5%</span> -->
                    </h5>
