                      ...
                      @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" value="{{ old('name') }}" class="form-control" id="fname" name="name" placeholder="Enter full name">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" value="{{ old('mobile') }}" class="form-control" id="mob" name="mobile" placeholder="Enter phone number">
                            </div>
                            <div class="col-sm-6">
