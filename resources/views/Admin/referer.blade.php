              ...
              <div class="row">
                <div class="col-lg-12 col-7">
                   <div class="d-flex flex-column flex-md-row align-items-center justify-content-between rounded gap-3">
                    <h2 class="h5 text-dark mb-0">Referers</h2>
                  </div>        
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">User Mobile No</th>
                  ...
                  <tbody>
                    ...
                    @foreach($referers as $referered)
                        <tr>
                            <td>
                                <h6 class="mb-0 text-sm">{{ $referered->user->name }}</h6>
                            </td>
                            <td>
                                <h6 class="mb-0 text-sm">{{ $referered->user->email }}</h6>
                            </td>
                            <td>
                                <h6 class="mb-0 text-sm">{{ $referered->user->phone_number }}</h6>
                            </td>
                            <td>
